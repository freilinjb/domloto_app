...
import { View,Text, Button,TouchableOpacity,Dimensions,TextInput,StyleSheet, ScrollView, StatusBar } from 'react-native';
        ...
        <View style={styles.container}>
            ...
            <Animatable.View animation="fadeInUpBig" style={styles.footer}>
                <ScrollView>
                    ...
                    <Text style={[styles.text_footer, {marginTop: 35}]}>Confirmar Contraseña</Text>
                    <View style={styles.action}>
                        <Feather name="lock" color="#05375a" size={20}/>
                        <TextInput 
